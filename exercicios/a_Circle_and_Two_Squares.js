...
function square_areas_difference(r){
    return Number((Math.pow(2*r, 2) - Math.pow((2*r)/Math.pow(2,0.5),2)).toFixed(0))
}
    
    

console.log(typeof square_areas_difference(5))

console.log(square_areas_difference(6))

console.log(square_areas_difference(7))